...
| Partícula | Verbo | Significado |
|:--------|:--------|:------------|
| が | 終わる | Terminado **de forma natural** |
| を | 終わる | No termina de forma **intencionada** (no estar planeado) |
| を | 終える | Termina de forma **inintencionada** (estar planeado) |
